...
export class ButtonComponent implements AfterViewInit {
  ...
  get bgColorClass(): string {
    switch (this.typeButton) {
      ...
      case "cancel":
        return "py-2 bg-error hover:bg-error-700 active:bg-error active:ring-2 active:ring-error/50 disabled:bg-error/40 disabled:active:ring-0 disabled:cursor-not-allowed";
      case "primary":
      default:
